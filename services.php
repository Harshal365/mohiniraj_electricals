            ...
            <div class="text-center">
                ...
                <ul class="listed-items">
                    ...
                    <li class="listed-items"><p class="list-sub-head">SOLAR PROJECTS:</p>
                        ...
                        <ul class="listed-lines">
                            <li>Turnkey Residential Rooftop Solar Installations under the PM-SURYAGHAR: Muft Bijli Yojana and customized Commercial and Industrial Solar Projects as per client requirements.</li>
