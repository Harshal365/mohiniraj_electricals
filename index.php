...
<head>
    ...
    <link rel="icon" href="./assets/MELogo.png">
    <title> Mohiniraj Electricals </title>
...
<body>
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg fixed-top" style="z-index: 100;">
            <div class="container-fluid">
                <div class="home-nav-logo">
                    <a href="index.php"><img src="./assets/MohinirajLogo2.png" alt="home-logo" class="home-nav-logo-img"></a>
                </div>
        ...
        <div class="mt-3">
            <h1 class="text-center main-heading">WELCOME TO MOHINIRAJ ELECTRICALS</h1>
        </div>

        <div class="row d-flex justify-content-around all-cards">
            <div class="col-md-11">
                <div class="d-flex justify-content-around align-items-center">
                    <p class="home-info"><strong>“Mohiniraj Electricals”</strong> is an established company in Power Sector for their prompt and quality services since 1988, 
        ...
        <section id="why-choose-us">
            <h2 class="text-center m-4">WHY CHOOSE MOHINIRAJ ELECTRICALS</h2>
        ...
        <div class="section">
            ...
            <footer>
                ...
                <div class="last-foot border-top">
                    <p class="text-center m-0 p-2 copyright">&copy; Mohiniraj Electricals Pvt. Ltd. All Rights Reserved.</p>
                </div>
            </footer>
    </div>
